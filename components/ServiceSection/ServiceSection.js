    ...
    return (
        <div className={`wpo-service-area section-padding ${props.sClass}`} id='service'>
            ...
            <SectionTitle 
                ...
                Description={'Je propose une gamme de services, allant du développement de sites web modernes et réactifs à la création de jeux vidéo immersifs. Que ce soit pour la conception d\'applications web, le développement de jeux sur mesure ou l\'optimisation de performances, je mets mes compétences à votre service pour donner vie à vos projets numériques.'} 
            />                
